...
//		Sources sources =  repo.findById(id)
	...
	@RequestMapping(value = "/updateSources", params = {"id", "collection", "sourceNumber", "callNumber", "author",
															"title", "inscription", "description", "msEntries"})
	public ModelAndView updateSources(@RequestParam int id, @RequestParam String collection, @RequestParam double sourceNumber,
							...
							@RequestParam String inscription, @RequestParam String description, @RequestParam String msEntries) {
		Sources sources = new Sources(id, collection, sourceNumber, callNumber, author, title, inscription, description, msEntries);
		repo.save(sources);
	...
	public Sources createSource(@RequestBody Sources sources) {
		...
		System.out.println(sources.getDescription());
		repo.save(sources);
	...
	@RequestMapping(value = "/createSources", params = {"collection", "sourceNumber", "callNumber"
			, "author", "title", "inscription", "description", "msEntries"})
	public ModelAndView createSources(@RequestParam String collection, @RequestParam double sourceNumber,
							@RequestParam String callNumber, @RequestParam String author, @RequestParam String title,
							@RequestParam String inscription, @RequestParam String description, @RequestParam String msEntries) {
		Sources sources = new Sources(collection, sourceNumber, callNumber, author, title, inscription, description, msEntries);
		repo.save(sources);
	...
	@RequestMapping(value = "/deleteSources", params = {"id", "collection", "sourceNumber",
										"callNumber", "author", "title", "inscription", "description", "msEntries"})
