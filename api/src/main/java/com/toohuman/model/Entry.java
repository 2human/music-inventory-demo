...
public class Entry {
	...
	@Column(name="entry_page_adjuster")
	private double pageAdjuster;
	

	private static final String[] FIELD_LIST = {"id", "collection", "sourceNumber", "location", "title", "composer",
                                                "vocalPart", "key", "melodicIncipit", "textIncipit", "isSecular", "notes", "pageAdjuster"};
	...
	public double getPageAdjuster() {
		return pageAdjuster;
	}
	
	public void setPageAdjuster(double pageAdjuster) {
		this.pageAdjuster = pageAdjuster;
	}
