...
//	@Column(name="id")
	...
	@Column(name="source_ms_entries")
	private String msEntries;							//description of current source, containing all details that cannot be parsed
	...
	public Sources(int id, String collection, double sourceNumber, String callNumber, String author, String title,
			String inscription, String description, String msEntries) {
